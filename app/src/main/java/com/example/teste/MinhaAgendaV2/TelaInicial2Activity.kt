...
class TelaInicial2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Agenda2.listaContato2.add(Contato2("1 luis", "111"))
        Agenda2.listaContato2.add(Contato2("2 luis", "222"))
        Agenda2.listaContato2.add(Contato2("3 felipe", "333"))
        Agenda2.listaContato2.add(Contato2("4 felipe", "444"))
        Agenda2.listaContato2.add(Contato2("5 conceição", "555"))
        Agenda2.listaContato2.add(Contato2("6 conceição", "666"))
        Agenda2.listaContato2.add(Contato2("7 inacio", "777"))
        Agenda2.listaContato2.add(Contato2("8 inacio", "888"))
        Agenda2.listaContato2.add(Contato2("9 inacio", "999"))
        Agenda2.listaContato2.add(Contato2("10 luis", "1000"))
        Agenda2.listaContato2.add(Contato2("11 luis", "1414"))
        Agenda2.listaContato2.add(Contato2("11 luis", "1414"))
        Agenda2.listaContato2.add(Contato2("11 luis", "1414"))
        Agenda2.listaContato2.add(Contato2("11 luis", "1414"))
        Agenda2.listaContato2.add(Contato2("11 luis", "1414"))
